...
\DoxyCodeLine{00011     srand(time(0));}
\DoxyCodeLine{00012 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00014}{14}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00014                     \{}
\DoxyCodeLine{00015     }
\DoxyCodeLine{00016     this-\/>negotiator-\/>\mbox{\hyperlink{classNegotiator_ac6ec48dbce55bf196c299342695054ef}{removeAlliance}}(\textcolor{keyword}{this});}
\DoxyCodeLine{00017 }
\DoxyCodeLine{00018     \textcolor{keywordflow}{if} (totalNum == 1)}
\DoxyCodeLine{00019         \textcolor{keyword}{delete} this-\/>negotiator;}
\DoxyCodeLine{00020 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00026}{26}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00026                                          \{}
\DoxyCodeLine{00027     members.push\_back(nation);}
\DoxyCodeLine{00028 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00048                                           \{}
\DoxyCodeLine{00049     production.push\_back(factory);}
\DoxyCodeLine{00050 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00040}{40}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00040                                               \{}
\DoxyCodeLine{00041     reserveEntities.push\_back(entity);}
\DoxyCodeLine{00042 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00077}{77}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00077                           \{}
\DoxyCodeLine{00078     }
\DoxyCodeLine{00079     \textcolor{keywordflow}{throw} \textcolor{stringliteral}{"{}Not yet implemented"{}};}
\DoxyCodeLine{00080 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00044}{44}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00044                              \{}
\DoxyCodeLine{00045     \textcolor{keywordflow}{return} (rand() \% 2 == 0);}
\DoxyCodeLine{00046 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00073}{73}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00073                         \{}
\DoxyCodeLine{00074     \textcolor{keywordflow}{return} active;}
\DoxyCodeLine{00075 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00058}{58}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00058                     \{}
\DoxyCodeLine{00059     \textcolor{keywordflow}{return} this-\/>aID;}
\DoxyCodeLine{00060 \}}
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00030}{30}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00030                                                        \{}
\DoxyCodeLine{00031     vector<Entity*> out;}
\DoxyCodeLine{00032     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < number \&\& i < reserveEntities.size(); i++) \{}
\DoxyCodeLine{00033         out.push\_back(reserveEntities[i]);}
\DoxyCodeLine{00034         reserveEntities.erase(reserveEntities.begin() + i);}
\DoxyCodeLine{00035     \}}
\DoxyCodeLine{00036 }
...
Definition at line \mbox{\hyperlink{Alliance_8cpp_source_l00062}{62}} of file \mbox{\hyperlink{Alliance_8cpp_source}{Alliance.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00062                           \{}
\DoxyCodeLine{00063 }
\DoxyCodeLine{00064     \textcolor{keywordflow}{if} (this-\/>negotiator-\/>\mbox{\hyperlink{classNegotiator_aa95e7f447a76c6d5ef84b92731ccb00d}{sendPeace}}(\textcolor{keyword}{this})) \textcolor{comment}{//Send the peace deal to all the alliances fighting against}}
\DoxyCodeLine{00065     \{}
\DoxyCodeLine{00066         this-\/>active = 3; \textcolor{comment}{//Number 3 means that Alliance chose to peacefully pull out of war}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00022                                                    \{}
\DoxyCodeLine{00023     this-\/>negotiator = negotiator;}
\DoxyCodeLine{00024 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00052                          \{}
\DoxyCodeLine{00053     this-\/>active = 2; \textcolor{comment}{//Number 2 means that Alliance has surrendered}}
\DoxyCodeLine{00054 }
\DoxyCodeLine{00055     this-\/>negotiator-\/>\mbox{\hyperlink{classNegotiator_ac6ec48dbce55bf196c299342695054ef}{removeAlliance}}(\textcolor{keyword}{this});}
\DoxyCodeLine{00056 \}}
