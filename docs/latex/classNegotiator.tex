...
\hyperlink{classNegotiator_add27a41f80fee92e8471b8ee9d9905f6}{$\sim$\+Negotiator} ()
\begin{DoxyCompactList}\small\item\em Destructor for the \hyperlink{classNegotiator}{Negotiator} object. \end{DoxyCompactList}\item 
bool \hyperlink{classNegotiator_aa95e7f447a76c6d5ef84b92731ccb00d}{send\+Peace} (\hyperlink{classAlliance}{Alliance} $\ast$offer\+Alliance)
\begin{DoxyCompactList}\small\item\em Tries to offer peace to all the alliances in vector. \end{DoxyCompactList}\item 
void \hyperlink{classNegotiator_ac6ec48dbce55bf196c299342695054ef}{remove\+Alliance} (\hyperlink{classAlliance}{Alliance} $\ast$old\+Alliance)
\begin{DoxyCompactList}\small\item\em Removes an alliance from the alliance vector. \end{DoxyCompactList}\item 
void \hyperlink{classNegotiator_acff1b9b66c8c7761d687b47a1a75883a}{add\+Alliance} (\hyperlink{classAlliance}{Alliance} $\ast$new\+Alliance)
...
int {\bfseries get\+Num\+Alliances} ()
\item 
...
{\footnotesize\ttfamily void Negotiator\+::add\+Alliance (\begin{DoxyParamCaption}\item[{\hyperlink{classAlliance}{Alliance} $\ast$}]{new\+Alliance }\end{DoxyParamCaption})}
=======
=======
>>>>>>> 7be49738cebc0ced3357f2ce74f6fda2ea0b3d5e
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
\item new\+Alliance must be an \hyperlink{classAlliance}{Alliance} pointer
=======
...
34                                                   \{
35     
36     \textcolor{keywordflow}{if} (std::find(alliances.begin(), alliances.end(), newAlliance) != alliances.end()) 
37         alliances.push\_back(newAlliance);
38     
39 \}
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
Definition at line 45 of file Negotiator.\+cpp.


\begin{DoxyCode}
45                               \{
46     
47     \textcolor{keywordflow}{throw} \textcolor{stringliteral}{"Not yet implemented"};
48 \}
\end{DoxyCode}
...
{\footnotesize\ttfamily void Negotiator\+::remove\+Alliance (\begin{DoxyParamCaption}\item[{\hyperlink{classAlliance}{Alliance} $\ast$}]{old\+Alliance }\end{DoxyParamCaption})}
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
\item old\+Alliance must be an \hyperlink{classAlliance}{Alliance} pointer
=======
...
24                                                      \{
25     
26     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} xx = 0; xx < alliances.size(); xx++)
27     \{
28         \textcolor{keywordflow}{if} (alliances[xx]->getID() == oldAlliance->\hyperlink{classAlliance_a7f23330454f02b0056eb92bd2072359d}{getID}())
29             alliances.erase( alliances.begin() + xx ); \textcolor{comment}{// Removes the specific alliances from this
       negotiator}
30     \}
31     
32 \}
...
{\footnotesize\ttfamily bool Negotiator\+::send\+Peace (\begin{DoxyParamCaption}\item[{\hyperlink{classAlliance}{Alliance} $\ast$}]{offer\+Alliance }\end{DoxyParamCaption})}
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
\item offer\+Alliance must be an \hyperlink{classAlliance}{Alliance} pointer
=======
...
10                                                   \{
11     
12     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} yy = 0; yy < alliances.size(); yy++)
13     \{
14         \textcolor{keywordflow}{if} (alliances[yy] != offerAlliance) \{
15             \textcolor{keywordflow}{if} (alliances[yy]->considerPeace() == \textcolor{keyword}{false})
16                 \textcolor{keywordflow}{return} \textcolor{keyword}{false}; \textcolor{comment}{// There is at least one enemy alliances that does not want the peace deal}
17         \}
18     
19     \}
20 
21     \textcolor{keywordflow}{return} \textcolor{keyword}{true}; \textcolor{comment}{// All the alliances being fought against agreed to the peace deal}
22 \}
=======
